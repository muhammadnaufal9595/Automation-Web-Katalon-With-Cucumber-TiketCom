...
class RegisterStepDefinition {
	/**
	 * The step definitions below match with Katalon sample Gherkin steps
	 */
	@Given("I navigate to loket.com website")
	def navigate(){
		WebUI.openBrowser("www.loket.com")
	}
	...
	def I_click_button_daftar(){
	}

	@And("I write my email")
	def I_write_my_email(){
	}

	@And("I write my password")
	def I_write_my_password(){
	}

	@And("I click the agreement box")
	def I_click_the_agreement_box(){
	}

	@And("I answer the captcha correctly")
	def I_answer_the_captcha_correctly(){
	}
